    ...
    return (<div className="w-full text-black mx-auto space-y-7">
      ...
      <div className="flex flex-col gap-4 sm:gap-6">
        ...
        <div className="flex gap-4">
          <Button type="button" className="w-1/2 bg-white text-black rounded-3xl py-5 border hover:bg-[#0082FF3D] border-[#0082FF] transition" onClick={() => router.push('/onboarding/choose-influencers')}>
            Back
          </Button>
          <Button type="button" className="w-1/2 bg-white text-black rounded-3xl py-5 border hover:bg-[#0082FF3D] border-[#0082FF] transition" onClick={() => router.push('/onboarding/welcome-onboarding')}>
            Later
          </Button>
        </div>
      </div>
