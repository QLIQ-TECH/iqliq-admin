...
const WelcomeOnboardingGrowBusiness = () => {
  ...
  const form = useForm<CheckBoxFormData>({
  ...
  const onSubmit = async (data: CheckBoxFormData) => {
    if (data.agree) {
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <Button
              ...
              className="w-1/2 rounded-3xl py-5 bg-[#0082FF3D] text-[#0082FF] hover:bg-[#0082FF66] transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              I Agree
            </Button>
          </div>
