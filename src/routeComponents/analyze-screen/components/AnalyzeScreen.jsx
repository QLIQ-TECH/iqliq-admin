...
const AnalyzeScreen = () => {
    ...
    return (<div className="w-full text-black mx-auto space-y-7">
      ...
      <div className="flex gap-4">
        <Button type="button" className="w-1/2 bg-white text-black rounded-3xl py-5 border border-[#0082FF] hover:bg-white transition" onClick={() => router.push('/onboarding/connect-store')}>
          Back
        </Button>
        <Button type="button" className="w-1/2 rounded-3xl py-5 bg-[#0082FF3D] text-[#0082FF] hover:bg-[#0082FF66] transition" onClick={() => router.push('/onboarding/kyc')}>
          Next
        </Button>
      </div>
    </div>);
