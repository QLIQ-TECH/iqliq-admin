				...
				<Popover
					...
					<PopoverTrigger asChild>
						<Button
							...
							className={cn(
								"flex p-1 rounded-xl border border-black min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
								...
								{!hideSelectAll && !searchValue && (
									<CommandGroup>
										<CommandItem
											...
											<div
												className={cn(
													"mr-2 flex h-4 w-4 items-center justify-center rounded-full border border-primary-foreground p-1",
													selectedValues.length ===
