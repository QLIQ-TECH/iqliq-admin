...
import { authApi, commissionApi } from '../apiClient';
...
export const commissionService = {
  ...
  // Update vendor commission on ecom-master user record (verified active vendors only)
  updateVendorCommission: async (vendorId, commissionRate) => {
    return await authApi.put(`/vendors/${vendorId}/commission`, {
      commissionRate
    });
  },
