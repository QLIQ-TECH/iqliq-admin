...
const Sidebar = ({ isOpen, onToggle, userType = 'superadmin', onLogout, user }) => {
  ...
  const vendorMenuItems = [
    ...
    { 
      id: 'creatorsPayment',
      icon: Wallet, 
      label: 'Creators Payment',
      children: [
        { label: 'Payment', href: '/vendor/creators-payment/payment' },
        { label: 'Owed', href: '/vendor/creators-payment/owed' },
        { label: 'History', href: '/vendor/creators-payment/history' },
      ]
    },
    { 
      id: 'store',
        ...
        <div className="flex flex-col h-full w-64">
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            {menuItems.map((item, index) => {
              ...
              const isVendorCampaigns =
                item.href === '/vendor/campaigns' &&
                pathname &&
                (pathname === '/vendor/campaigns' || pathname.startsWith('/vendor/campaigns/'));
              const isActive = isVendorCampaigns || pathname === item.href;
