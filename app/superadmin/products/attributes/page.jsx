            ...
            <div className="mt-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="relative" ref={categoryDropdownRef}>
                  ...
                  <button
                    type="button"
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-left bg-white hover:bg-gray-50 transition-colors"
                        ...
                        {filteredCategories.length === 0 ? (
                          ...
                          <table className="min-w-full text-sm">
                            <thead className="bg-gray-50 sticky top-0">
                              <tr>
                                <th className="w-16 px-3 py-2 text-left font-medium text-gray-600">Pick</th>
                                <th className="px-3 py-2 text-left font-medium text-gray-600">Category</th>
                                <th className="w-20 px-3 py-2 text-left font-medium text-gray-600">Level</th>
                              </tr>
                            </thead>
                            <tbody>
                              {filteredCategories.map((category) => (
                                ...
                                >
                                  ...
                                  <td className="px-3 py-2 text-gray-500">{category.level ?? '-'}</td>
                                </tr>
                              ))}
                            </tbody>
                          </table>
                            ...
                            {formData.categoryIds.map((categoryId) => {
                              ...
                              return (
                                <tr key={categoryId} className="border-t">
                                  <td className="px-3 py-2 text-gray-700">{category.name}</td>
                                  <td className="w-16 px-3 py-2 text-gray-500">{category.level ?? '-'}</td>
